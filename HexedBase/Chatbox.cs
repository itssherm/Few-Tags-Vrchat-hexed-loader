            ...
            try
            {
                ...
                if (HasCustomColor(vrcPlayer.field_Private_APIUser_0) == true)
                {
                    for (int i = 0; i < _customcolor?.Length; i++)
                    {
                        if (vrcPlayer.IsMe() == true)
                        {
                            ...
                            VRCPlayer.field_Internal_Static_VRCPlayer_0.field_Public_GameObject_0.gameObject.transform.FindChild("ChatBubble/Canvas/TypingIndicator/Text").transform.gameObject.GetComponent<TextMeshProUGUI>().color = new Color(_customcolor[i].textred, _customcolor[i].textgreen, _customcolor[i].textblue, 1);
                            ...
                            VRCPlayer.field_Internal_Static_VRCPlayer_0.field_Public_GameObject_0.gameObject.transform.FindChild("ChatBubbleMirror/Canvas/TypingIndicator/Text").transform.gameObject.GetComponent<TextMeshProUGUI>().color = new Color(_customcolor[i].textred, _customcolor[i].textgreen, _customcolor[i].textblue, 1);
                        }
                        else
                        {
                            ...
                            vrcPlayer._vrcplayer.field_Public_GameObject_0.gameObject.transform.FindChild("ChatBubble/Canvas/TypingIndicator/Text").transform.gameObject.GetComponent<TextMeshProUGUI>().color = new Color(_customcolor[i].textred, _customcolor[i].textgreen, _customcolor[i].textblue, 1);
                        }
                    }
                }
                else
                {
                    if (vrcPlayer.IsMe() == true)
                    {
                        ...
                        VRCPlayer.field_Internal_Static_VRCPlayer_0.field_Public_GameObject_0.gameObject.transform.FindChild("ChatBubble/Canvas/TypingIndicator/Text").transform.gameObject.GetComponent<TextMeshProUGUI>().color = Color.red;
                        ...
                        VRCPlayer.field_Internal_Static_VRCPlayer_0.field_Public_GameObject_0.gameObject.transform.FindChild("ChatBubbleMirror/Canvas/TypingIndicator/Text").transform.gameObject.GetComponent<TextMeshProUGUI>().color = Color.red;
                    }
                    else if (vrcPlayer.field_Private_APIUser_0.isFriend)
                    {
                        ...
                        vrcPlayer._vrcplayer.field_Public_GameObject_0.gameObject.transform.FindChild("ChatBubble/Canvas/TypingIndicator/Text").transform.gameObject.GetComponent<TextMeshProUGUI>().color = Color.cyan;
                    }
                    else
                    {
